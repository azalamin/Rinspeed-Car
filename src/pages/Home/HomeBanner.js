      ...
      >
        <div>
          <h1
            ...
            className="font-bold text-center text-4xl sm:text-7xl text-white"
          >
          ...
          <h4
            ...
            className="font-bold my-4 text-center text-2xl sm:text-4xl text-white"
          >
          ...
          >
            ...
            <a
              href="#parts"
              className="px-5 py-3 block sm:inline-block rounded uppercase shadow-lg shadow-white hover:bg-primary hover:shadow-primary hover:text-white font-semibold bg-white w-full sm:w-auto"
            >
              Our Parts
            </a>
          </div>
